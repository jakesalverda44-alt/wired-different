...
- **Jake's photo** — the homepage "Who's behind it" section shows a CSS/SVG hex-ring "JS" monogram. Once `assets/jake.webp` exists, swap it in: in `index.html` replace the `<svg class="about-block__mono">...</svg>` with `<img src="/assets/jake.webp" alt="Jake" width="200" height="200">` (see the HTML comment right above it).
